...
* Client / Server
  ...
  * 메일 서버, SQL 데이터 서버, 기업 ERP, 웹 서버 등이 Server의 위치가 될 수 있음
...
* Network 수 : 2^7 -2 = 126 (A Class에서"만" 0과 127은 특수하게 쓰임)
...
>
> 10101100.00010000.**10**000000.00000000/18 => `172.16.128.0/18`	 `172.16.128.1` ~ `172.16.191.254`
>
